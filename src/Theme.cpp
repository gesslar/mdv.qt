...
QColor Theme::editorLineNumberActive() { return QColor::fromString("#6691b9e6"); }
...
QTextCharFormat Theme::formatFor(Token t) {
  ...
  switch (t) {
    case Text:           f.setForeground(editorForeground());                       break;

    case Comment:        f.setForeground(commentGray());                            break;
    case Keyword:        f.setForeground(keywordBlue());                            break;
    case ControlFlow:    f.setForeground(controlPink());                            break;
    case Operator:       f.setForeground(neutralGray());                            break;
    case Number:         f.setForeground(numberGreen());                            break;
    case String:         f.setForeground(stringPeach());                            break;
    case StringEscape:   f.setForeground(selectorTan());                            break;
    case Character:      f.setForeground(keywordBlue());                            break;
    case Regex:          f.setForeground(regexRust());                              break;
    case Constant:       f.setForeground(constantBlue());                           break;
    case Variable:       f.setForeground(variableBlue());                           break;
    case Function:       f.setForeground(functionOlive());                          break;
    case Type:           f.setForeground(typeTeal());                               break;
    case Class:          f.setForeground(typeTeal());                               break;
    case Attribute:      f.setForeground(variableBlue());                           break;
    case Tag:            f.setForeground(keywordBlue());                            break;
    case Preprocessor:   f.setForeground(keywordBlue());                            break;
    case Label:          f.setForeground(labelGray());                              break;
    case Invalid:
    ...
    case MarkupItalic:
      ...
      break;
    case MarkupCode:     f.setForeground(stringPeach());                            break;
    case MarkupQuote:    f.setForeground(commentGray());                            break;
    case MarkupList:     f.setForeground(listBlue());                               break;
    case MarkupInserted: f.setForeground(numberGreen());                            break;
    case MarkupDeleted:  f.setForeground(stringPeach());                            break;
    case MarkupChanged:  f.setForeground(keywordBlue());                            break;
  }
